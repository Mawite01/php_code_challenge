...
final class FinalResultTest extends TestCase
{
    ...
    {
        $result = $this->finalResult->results();
    ...
    {
        $finalResult = new finalResult($this->invalidFilePath);
    ...
    public function testReturnsTheCorrectHash(): void
    {
        ...
        $this->assertEquals($result, $this->expected_return());
    }

    private function expected_return(): array
    {
        return [
